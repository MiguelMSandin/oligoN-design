...
- first, find all potential oligos with the script [findPrimer](https://github.com/MiguelMSandin/oligoN-design/tree/main/scripts/findPrimer),
- second, test all potential oligos for hits allowing 1 and 2 mismatches with the script [testPrimer.py](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/others/testPrimer.py),
- third, align the selected template (where an accessibility map has been empirically tested) to the consensus of the target file and the oligos with the script [alignPrimers](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/alignPrimers),
- fourth, rate the accessibility of all oligos with the script [rateAccess](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/rateAccess),
- fifth, bind all different log files with the script [bindLogs](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/bindLogs),
- sixth, filter the oligos to obtain only the highest quality statistics with the script [filterLog](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/filterLog).
...
(If you had already selected your probes, you can still analyse them following the logic from **Step 1** and **Step 2** with the script [assessPrimer](https://github.com/MiguelMSandin/oligoN-design/blob/main/scripts/assessPrimer).)  
